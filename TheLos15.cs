...
public class TheLos15 : MonoBehaviour
{
    public int inter;
    public int inter1;
    public int inter2;
    ...
    void Awake()
    {
        inter = Random.Range(1, 26);
        inter1 = Random.Range(1, 26);
        inter2 = Random.Range(1, 26);
        inter3 = Random.Range(1, 26);
    ...
    void Update()
    {
        if (inter1 == inter || inter1 == inter2 || inter2 == inter3)
        {
            Repeat();
        }
        if (inter2 == inter || inter2 == inter1 || inter2 == inter3)
        {
            Repeat1();
        }
        if (inter3 == inter || inter3 == inter1 || inter3 == inter2)
        {
            Repeat2();
        }
    }
    void Repeat()
    {
        inter1 = Random.Range(1, 31);
    }
    void Repeat1()
    {
        inter2 = Random.Range(1, 31);
    }
    void Repeat2()
    {
        inter3 = Random.Range(1, 31);
    }
}