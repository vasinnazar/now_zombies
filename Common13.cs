...
public class Common13 : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        toin = GameObject.Find("Field").GetComponent<TheLos8>().inter;
        toin1 = GameObject.Find("Field").GetComponent<TheLos8>().inter1;
        if (toin == tocompare || toin1 == tocompare)
        {
            zom = 1;
        }
  ...
  style= col.gameObject.GetComponent<Common13>().i;
