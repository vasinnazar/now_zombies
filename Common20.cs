...
public class Common20 : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        toin = GameObject.Find("Field").GetComponent<TheLos14>().inter;
        toin1 = GameObject.Find("Field").GetComponent<TheLos14>().inter1;
        toin2 = GameObject.Find("Field").GetComponent<TheLos14>().inter2;
        toin3 = GameObject.Find("Field").GetComponent<TheLos14>().inter3;
  ...
  style= col.gameObject.GetComponent<Common20>().i;
