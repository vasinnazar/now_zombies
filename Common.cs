...
public class Common : MonoBehaviour
{
   ...
   // private IEnumerator coroutine6;
    ...
    //private IEnumerator coroutine8;
    ...
    void Start()
    {
        ...
        toin = GameObject.Find("Field").GetComponent<TheLos6>().inter;
        if (toin == tocompare)
        {
            zom = 1;
        }
...
if (isTouched())
    ...
    /*private IEnumerator WaitAndPrint8(float waitTime)
    {
        while (true)
        {
            yield return new WaitForSeconds(waitTime);
...
zom -= Random.Range(0, 5);
  ...
  style= col.gameObject.GetComponent<Common>().i;
