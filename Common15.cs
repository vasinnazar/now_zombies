...
public class Common15 : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        toin = GameObject.Find("Field").GetComponent<TheLos3>().inter;
        toin1 = GameObject.Find("Field").GetComponent<TheLos3>().inter1;
        toin2 = GameObject.Find("Field").GetComponent<TheLos3>().inter2;
        toin3 = GameObject.Find("Field").GetComponent<TheLos3>().inter3;
        if (toin == tocompare || toin1 == tocompare || toin2 == tocompare || toin3 == tocompare)
        {
            zom = 1;
        }
  ...
  style= col.gameObject.GetComponent<Common15>().i;
