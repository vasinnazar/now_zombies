...
public class Common8 : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        toin = GameObject.Find("Field").GetComponent<TheLos12>().inter;
        toin1 = GameObject.Find("Field").GetComponent<TheLos12>().inter1;
        toin2 = GameObject.Find("Field").GetComponent<TheLos12>().inter2;
  ...
  style= col.gameObject.GetComponent<Common8>().i;
