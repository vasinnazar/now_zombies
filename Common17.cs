...
public class Common17 : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        toin = GameObject.Find("Field").GetComponent<TheLos2>().inter;
        toin1 = GameObject.Find("Field").GetComponent<TheLos2>().inter1;
        toin2 = GameObject.Find("Field").GetComponent<TheLos2>().inter2;
  ...
  style= col.gameObject.GetComponent<Common17>().i;
