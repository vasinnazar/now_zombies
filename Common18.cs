...
public class Common18 : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        toin = GameObject.Find("Field").GetComponent<TheLos13>().inter;
        toin1 = GameObject.Find("Field").GetComponent<TheLos13>().inter1;
        toin2 = GameObject.Find("Field").GetComponent<TheLos13>().inter2;
        toin3 = GameObject.Find("Field").GetComponent<TheLos13>().inter3;
  ...
  style= col.gameObject.GetComponent<Common18>().i;
