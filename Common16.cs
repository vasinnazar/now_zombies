...
public class Common16 : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        toin = GameObject.Find("Field").GetComponent<TheLos1>().inter;
        toin1 = GameObject.Find("Field").GetComponent<TheLos1>().inter1;
  ...
  style= col.gameObject.GetComponent<Common16>().i;
